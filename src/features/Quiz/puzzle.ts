export const puzzles = {
  puzzles: [
    ...
    },
    {
      ...
      "clue": "One final problem to reach your destination:\n- Multiply the difference between the current year and the year we first met by the number of letters in Vinnie's name.\n- Then, add the month of our first meeting.",
      "solution": {
        "current_year": 2024,
        "year_met": 2021,
        "vinnies_name_length": 6,
        "month_met": 2,
        "hint": "Vinnie loves to play fetch!",
        "formula": "(2024 - 2021) \\times 6 + 2",
        "calculation": [
          "(2024 - 2021) = 3",
          "3 * 6 = 18",
          "18 + 2 = 20"
