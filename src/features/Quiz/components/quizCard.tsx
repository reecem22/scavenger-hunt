  ...
  return (
    <Card className="w-full max-w-md">
      <CardHeader>
        ...
        <CardDescription className="text-md mt-2">{question}</CardDescription>
      </CardHeader>
      ...
      <CardContent>
        ...
        {hasSumit && (
          ...
          >
            {isCorrect ? (
              <CheckCircle id="rewardId" className="text-green-500 w-8 h-8" />
            ) : (
      ...
      <CardFooter className="flex justify-between">
        <PuzzleOneHint hintString={solution.hint} formula={solution.formula} />
        {isCorrect === false ? (
